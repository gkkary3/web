...
document.getElementById("btn1").addEventListener("click", function(){
    ...
    //결과 출력
    div1.innerHTML = ""; //div1 내부 내용을 지워라.
...
function Student(name, grade, ban){
    ...
    this.grade = grade; //생성되는 객체 name에 매개변수 name을 대입
    this.ban = ban; //생성되는 객체 name에 매개변수 name을 대입
...
document.getElementById("btn2").addEventListener("click", function(){
    ...
    const std2 = new Student("홍길순", 2 , 2);
    const std3 = new Student("김길동", 1 , 2);
    console.log(std1);
    console.log(std2);
    console.log(std3);
