...
document.getElementById("btn2").addEventListener("click", function(){
    ...
    // #test의 마지막 자식 요소
    document.getElementById("test").lastElementChild.style.backgroundColor = "blue"

    // #test의 자식 중 2번 인덱스의 이전/다음 형제요소
    ...
    console.log( prevE1(prevEl(list[2])));
...
document.getElementById("btn3-2").addEventListener("click",function(){
    ...
    //createElement를 이용하여 div요소 생성
    // document.createElement("태그명") : 해당 태그 요소를 생성하여 반환
    const child = document.createElement("div"); // div생성 O, 화면 배치 X 
